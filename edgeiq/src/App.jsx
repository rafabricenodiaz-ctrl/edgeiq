...
function getFallbackFantasy() {
  return [
    { name: "Shai Gilgeous-Alexander", team: "Thunder", league: "NBA", position: "G", projection: "32.5", projStat: "PTS", analysis: "SGA is averaging 34.2 PPG in his last 7 games and faces a Clippers defense ranked 24th in opponent guard scoring. Kawhi's minutes restriction leaves Clippers' perimeter defense depleted — ideal PrizePicks spot.", props: [{ stat: "Points", line: "31.5", rec: "over", reason: "34.2 avg last 7, vs weak Clippers D" }, { stat: "Assists", line: "5.5", rec: "over", reason: "Averaging 6.2 APG last month" }] },
    { name: "Jayson Tatum", team: "Celtics", league: "NBA", position: "SF", projection: "29.8", projStat: "PTS", analysis: "Tatum has gone over 28.5 points in 5 of last 6 home games. With Jimmy Butler out, Miami's wing defense collapses to Bam Adebayo alone — Tatum should feast in the mid-range. Monitor his 3PT attempts closely.", props: [{ stat: "Points", line: "28.5", rec: "over", reason: "28+ in 5/6 home games, Butler absent" }, { stat: "Rebounds", line: "8.5", rec: "over", reason: "Averaging 9.1 boards vs Heat this season" }] },
    { name: "Patrick Mahomes", team: "Chiefs", league: "NFL", position: "QB", projection: "285.5", projStat: "YDS", analysis: "Cold-weather game (34°F, 18mph wind) limits deep passing but Mahomes excels in these conditions: 7-1 in sub-40°F games. Expect heavy short-to-intermediate passing, 25+ attempts. Watch the under on passing yards.", props: [{ stat: "Pass Yards", line: "289.5", rec: "under", reason: "Cold + wind reduces deep ball, 34°F" }, { stat: "TDs", line: "1.5", rec: "over", reason: "7-1 cold weather record, red zone dominant" }] },
    { name: "Bukayo Saka", team: "Arsenal", league: "EPL", position: "RW", projection: "4.5", projStat: "SHOTS", analysis: "Saka has registered a shot on target in 11 straight home matches and the Wolves right back position has been exploited for 4.2 key chances per 90 this season. Clear weather at Emirates is ideal.", props: [{ stat: "Shots on Target", line: "1.5", rec: "over", reason: "Shot in 11 straight home games" }, { stat: "Assists", line: "0.5", rec: "over", reason: "3 assists last 4 home matches" }] },
    { name: "Lionel Messi", team: "Inter Miami", league: "MLS", position: "RW", projection: "6.5", projStat: "TOUCHES IN BOX", analysis: "Messi confirmed fit and starting tonight. He's averaged 7.2 touches in the box per home game and Red Bulls have allowed 5+ key chances in their last 4 away matches. Prime PrizePicks value.", props: [{ stat: "Shots", line: "3.5", rec: "over", reason: "4.1 avg shots at home since return" }, { stat: "Key Passes", line: "2.5", rec: "over", reason: "3.2 KP avg vs weaker road defenses" }] },
    { name: "Henry Martin", team: "América", league: "Liga MX", position: "ST", projection: "2.5", projStat: "SHOTS", analysis: "Henry Martin has scored or assisted in 8 of his last 10 games for América. Cruz Azul concede 1.8 goals per away match this Clausura and Martin's movement in behind will trouble their high defensive line in the derby.", props: [{ stat: "Shots", line: "2.5", rec: "over", reason: "3.1 shots avg in Clásico matches" }, { stat: "Goals", line: "0.5", rec: "over", reason: "8 G+A in last 10, vs porous Cruz Azul" }] },
  ];
}
